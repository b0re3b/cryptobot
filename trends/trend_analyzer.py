...
class TrendAnalyzer:
    ...
    def detect_trend(self, data: pd.DataFrame, window_size: int = 14) -> str:
        """Виявлення тренду на основі множинних технічних індикаторів з ваговими коефіцієнтами"""
        try:
    ...
    def _calculate_adx_manual(self, df: pd.DataFrame, period: int = 14) -> pd.DataFrame:
        """Ручний розрахунок ADX у випадку, якщо pandas-ta не спрацював"""
        try:
    ...
    def _calculate_macd_manual(self, df: pd.DataFrame) -> pd.DataFrame:
        """Ручний розрахунок MACD у випадку, якщо pandas-ta не спрацював"""
        try:
    ...
    def calculate_trend_strength(self, data: pd.DataFrame) -> float:
        """Розрахунок сили тренду на основі комбінації індикаторів"""
        try:
